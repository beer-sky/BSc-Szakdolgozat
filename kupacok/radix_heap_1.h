...
#ifndef LEMON_RADIX_HEAP_1_H
#define LEMON_RADIX_HEAP_1_H
...
namespace lemon
{
    ...
    public:
        ...
        RadixHeap1(ItemIntMap &map, int minimum = 0, int capacity = 0)
            : _iim(map)
        {
    ...
    public:
        ...
        Item top() const
        {
            const_cast<RadixHeap1<ItemIntMap> &>(*this).moveDown();
